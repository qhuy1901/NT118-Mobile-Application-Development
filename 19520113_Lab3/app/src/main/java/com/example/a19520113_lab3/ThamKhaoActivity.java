...
import com.example.a19520113_lab3.adapter.DbAdapter;
...
public class ThamKhaoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tham_khao);
    ...
    private void showData() {
        ...
        ArrayAdapter<String> userAdapter = new ArrayAdapter<String>(ThamKhaoActivity.this, R.layout.item_user, users);
